...
namespace Stream_Cipher_Tests
{
    public class StreamCipherServiceTests
    {
        ...
        public void EncodeSynchronousStreamCiper(string input, string seed, string polynomial, string output)
        {
        ...
        [TestCase("1001111111110101", "0110110", "1111000", "1010111001111001")]
        [TestCase("1100111100110110", "10101110", "11100001", "1101000101000000")]
        public void DecodeSynchronousStreamCiper(string output, string seed, string polynomial, string input)
        {
            var result = streamCipherService.Synchronous_Stream_Cipher_Encode_Decode(input, seed, polynomial);
        ...
        public void EncodeCiphertextAutokey(string input, string seed, string polynomial, string output)
        {
        ...
        public void DecodeCiphertextAutokey(string input, string seed, string polynomial, string output)
        {
